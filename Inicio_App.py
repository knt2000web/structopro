...
<div class="norms-grid">
  <div class="norm-card"><svg width="28" height="20" viewBox="0 0 28 20" xmlns="http://www.w3.org/2000/svg"><rect width="28" height="20" rx="2" fill="#FCD116"/><rect width="28" height="7" y="0" fill="#003893"/><rect width="28" height="7" y="13" fill="#CE1126"/></svg><div><div class="norm-name">NSR-10</div><div class="norm-country">Colombia — Título C</div></div></div>
  ...
  <div class="norm-card"><svg width="28" height="20" viewBox="0 0 28 20" xmlns="http://www.w3.org/2000/svg"><rect width="28" height="20" rx="2" fill="#FFD100"/><rect width="9.3" height="20" fill="#003893"/><rect x="18.7" width="9.3" height="20" fill="#CE1126"/></svg><div><div class="norm-name">NEC-SE-HM</div><div class="norm-country">Ecuador</div></div></div>
  <div class="norm-card"><svg width="28" height="20" viewBox="0 0 28 20" xmlns="http://www.w3.org/2000/svg"><rect width="28" height="20" rx="2" fill="#D91023"/><rect width="28" height="6.6" fill="#D91023"/><rect y="6.6" width="28" height="6.6" fill="white"/><rect y="13.3" width="28" height="6.7" fill="#D91023"/></svg><div><div class="norm-name">E.060</div><div class="norm-country">Perú</div></div></div>
  <div class="norm-card"><svg width="28" height="20" viewBox="0 0 28 20" xmlns="http://www.w3.org/2000/svg"><rect width="28" height="20" rx="2" fill="#006847"/><rect x="9.3" width="9.4" height="20" fill="white"/><rect x="9.3" width="9.4" height="20" fill="#CE1126" opacity="0.9"/><rect width="9.3" height="20" fill="#006847"/><rect x="18.7" width="9.3" height="20" fill="#006847"/></svg><div><div class="norm-name">NTC-EM</div><div class="norm-country">México — RCDF 2017</div></div></div>
  <div class="norm-card"><svg width="28" height="20" viewBox="0 0 28 20" xmlns="http://www.w3.org/2000/svg"><rect width="28" height="20" rx="2" fill="#CF142B"/><rect y="6.6" width="28" height="6.8" fill="#FFD200"/></svg><div><div class="norm-name">COVENIN 1753</div><div class="norm-country">Venezuela — 2006</div></div></div>
  <div class="norm-card"><svg width="28" height="20" viewBox="0 0 28 20" xmlns="http://www.w3.org/2000/svg"><rect width="28" height="20" rx="2" fill="#D52B1E"/><rect width="9.3" height="20" fill="#007A3D"/><rect x="18.7" width="9.3" height="20" fill="#FFD100"/></svg><div><div class="norm-name">NB 1225001</div><div class="norm-country">Bolivia — 2020</div></div></div>
