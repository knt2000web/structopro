...
st.markdown("""<div style="width:100%;overflow:hidden;border-radius:14px;margin-bottom:20px;box-shadow:0 4px 32px #0008;"><svg viewBox="0 0 1100 220" xmlns="http://www.w3.org/2000/svg" style="width:100%;display:block;background:linear-gradient(135deg,#0a1128 0%,#1c2541 100%);"><g opacity="0.1" stroke="#38bdf8" stroke-width="0.5"><line x1="0" y1="55" x2="1100" y2="55"/><line x1="0" y1="110" x2="1100" y2="110"/><line x1="0" y1="165" x2="1100" y2="165"/><line x1="220" y1="0" x2="220" y2="220"/><line x1="440" y1="0" x2="440" y2="220"/><line x1="660" y1="0" x2="660" y2="220"/></g><rect x="0" y="0" width="1100" height="3" fill="#f59e0b" opacity="0.9"/><rect x="0" y="217" width="1100" height="3" fill="#f59e0b" opacity="0.7"/><g transform="translate(50,20)"><line x1="10" y1="140" x2="160" y2="140" stroke="#475569" stroke-width="2"/><line x1="10" y1="140" x2="10" y2="20" stroke="#475569" stroke-width="2"/><path d="M10,60 L40,30 L75,30 L130,80 L160,100" fill="none" stroke="#f59e0b" stroke-width="3"/><text x="85" y="160" text-anchor="middle" font-family="monospace" font-size="8" fill="#94a3b8">T (seg)</text><text x="-10" y="30" font-family="monospace" font-size="8" fill="#94a3b8" transform="rotate(-90,-10,30)">Sa (g)</text><text x="85" y="12" text-anchor="middle" font-family="sans-serif" font-size="9" font-weight="600" fill="#cbd5e1" letter-spacing="1">ESPECTRO Sa(T)</text></g><g transform="translate(560,0)"><rect x="0" y="28" width="4" height="165" rx="2" fill="#f59e0b"/><text x="18" y="68" font-family="Arial,sans-serif" font-size="28" font-weight="bold" fill="#ffffff">DISEÑO SISMICO</text><text x="18" y="96" font-family="Arial,sans-serif" font-size="14" font-weight="300" fill="#93c5fd" letter-spacing="2">ESPECTROS DE DISEÑO NSR-10 · ASCE 7</text><rect x="18" y="104" width="480" height="1" fill="#f59e0b" opacity="0.5"/><rect x="18" y="115" width="90" height="22" rx="11" fill="#291400" stroke="#f59e0b" stroke-width="1"/><text x="63" y="130" text-anchor="middle" font-family="Arial,sans-serif" font-size="9" font-weight="bold" fill="#fcd34d">NSR-10 A.2</text><rect x="118" y="115" width="118" height="22" rx="11" fill="#052e16" stroke="#10b981" stroke-width="1"/><text x="177" y="130" text-anchor="middle" font-family="Arial,sans-serif" font-size="9" font-weight="bold" fill="#6ee7b7">ESPECTRO Sa(T)</text><rect x="246" y="115" width="90" height="22" rx="11" fill="#3a0000" stroke="#ef4444" stroke-width="1"/><text x="291" y="130" text-anchor="middle" font-family="Arial,sans-serif" font-size="9" font-weight="bold" fill="#fca5a5">DCR GLOBAL</text><rect x="346" y="115" width="125" height="22" rx="11" fill="#1e1b4b" stroke="#8b5cf6" stroke-width="1"/><text x="408" y="130" text-anchor="middle" font-family="Arial,sans-serif" font-size="9" font-weight="bold" fill="#c4b5fd">IRREGULARIDADES</text><text x="18" y="156" font-family="Arial,sans-serif" font-size="11" fill="#94a3b8">Construcción del Espectro de Diseño Elástico (Sa) de NSR-10 Título A y ASCE 7-22.</text><text x="18" y="172" font-family="Arial,sans-serif" font-size="11" fill="#94a3b8">Verificación de irregularidades en planta y altura, determinación del sistema estructural</text><text x="18" y="188" font-family="Arial,sans-serif" font-size="11" fill="#94a3b8">y clasificación de grupo de uso. Calcula Vb según método estático equivalente.</text></g></svg></div>""", unsafe_allow_html=True)
