...
st.markdown("""<div style="width:100%;overflow:hidden;border-radius:14px;margin-bottom:20px;box-shadow:0 4px 32px #0008;"><svg viewBox="0 0 1100 220" xmlns="http://www.w3.org/2000/svg" style="width:100%;display:block;background:linear-gradient(135deg,#0a1128 0%,#1c2541 100%);"><g opacity="0.1" stroke="#38bdf8" stroke-width="0.5"><line x1="0" y1="55" x2="1100" y2="55"/><line x1="0" y1="110" x2="1100" y2="110"/><line x1="0" y1="165" x2="1100" y2="165"/><line x1="220" y1="0" x2="220" y2="220"/><line x1="440" y1="0" x2="440" y2="220"/><line x1="660" y1="0" x2="660" y2="220"/></g><rect x="0" y="0" width="1100" height="3" fill="#ef4444" opacity="0.9"/><rect x="0" y="217" width="1100" height="3" fill="#ef4444" opacity="0.7"/><g transform="translate(50,30)"><rect x="0" y="40" width="5" height="100" fill="#ef4444" opacity="0.8"/><rect x="0" y="40" width="50" height="7" fill="#ef4444" opacity="0.8"/><rect x="0" y="133" width="50" height="7" fill="#ef4444" opacity="0.8"/><rect x="22" y="47" width="5" height="86" fill="#fca5a5" opacity="0.5"/><text x="55" y="55" font-family="monospace" font-size="9" fill="#94a3b8">bf</text><text x="55" y="95" font-family="monospace" font-size="9" fill="#94a3b8">tw</text><text x="55" y="135" font-family="monospace" font-size="9" fill="#94a3b8">bf</text><text x="25" y="10" text-anchor="middle" font-family="sans-serif" font-size="9" font-weight="600" fill="#cbd5e1" letter-spacing="1">PERFIL W</text></g><g transform="translate(560,0)"><rect x="0" y="28" width="4" height="165" rx="2" fill="#ef4444"/><text x="18" y="68" font-family="Arial,sans-serif" font-size="28" font-weight="bold" fill="#ffffff">ESTRUCTURAS METALICAS</text><text x="18" y="96" font-family="Arial,sans-serif" font-size="14" font-weight="300" fill="#93c5fd" letter-spacing="2">PERFILES W / HSS · AISC 360 / NSR-10</text><rect x="18" y="104" width="480" height="1" fill="#ef4444" opacity="0.5"/><rect x="18" y="115" width="97" height="22" rx="11" fill="#3a0000" stroke="#ef4444" stroke-width="1"/><text x="66" y="130" text-anchor="middle" font-family="Arial,sans-serif" font-size="9" font-weight="bold" fill="#fca5a5">AISC 360-22</text><rect x="125" y="115" width="118" height="22" rx="11" fill="#291400" stroke="#f59e0b" stroke-width="1"/><text x="184" y="130" text-anchor="middle" font-family="Arial,sans-serif" font-size="9" font-weight="bold" fill="#fcd34d">PERFILES W/HSS</text><rect x="253" y="115" width="90" height="22" rx="11" fill="#052e16" stroke="#10b981" stroke-width="1"/><text x="298" y="130" text-anchor="middle" font-family="Arial,sans-serif" font-size="9" font-weight="bold" fill="#6ee7b7">CONEXIONES</text><rect x="353" y="115" width="80" height="22" rx="11" fill="#0c1a2e" stroke="#3b82f6" stroke-width="1"/><text x="393" y="130" text-anchor="middle" font-family="Arial,sans-serif" font-size="9" font-weight="bold" fill="#93c5fd">DXF/IFC</text><text x="18" y="156" font-family="Arial,sans-serif" font-size="11" fill="#94a3b8">Verificación en flexión, cortante, pandeo local/global y longitud de pandeo efectiva</text><text x="18" y="172" font-family="Arial,sans-serif" font-size="11" fill="#94a3b8">para perfiles laminados W, IPN/IPE y secciones cajón HSS. Predimensionamiento AISC.</text><text x="18" y="188" font-family="Arial,sans-serif" font-size="11" fill="#94a3b8">Conexiones soldadas y atornilladas. Exporta planos DXF y modelo BIM metálico.</text></g></svg></div>""", unsafe_allow_html=True)
